...
Текущая ветка будет отмечена звездочкой
 ...
 `
 Если была изменена одна и та же часть файла в обеих ветках, то может возниикывывываывнуть конфликт, который потребует участия пользователя. VisualStudioCod предлагает варианты разрешения конфлвлосялвшофщшывофвфы